...
exports.noregis = () => {
	return`*「 BELUM DAFTAR 」*\n\n*Ô zz para ter acesso ao menu você tem que se cadastrar daftar ${prefix}daftar nome|idade* \n*ex: ${prefix}daftar bruxinho|19*`
}

exports.rediregis = () => {
	return`*「 SUDAH DAFTAR 」*\n\n*você se registrou no banco de dados do bot Netinho lindinho*`
}
